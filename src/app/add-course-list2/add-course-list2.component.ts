...
@Component({
  selector: 'app-add-course-list2',
  templateUrl: './add-course-list2.component.html',
  styleUrls: ['./add-course-list2.component.css']
})
export class AddCourseList2Component implements OnInit {
...
sendData(form:any)
{
  ...
  if(form.valid){
    this._AuthonticationService.addCourseListLev2(form.value).subscribe({
      next:(data)=>{
        // console.log({data})
