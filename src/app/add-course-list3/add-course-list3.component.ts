...
@Component({
  selector: 'app-add-course-list3',
  templateUrl: './add-course-list3.component.html',
  styleUrls: ['./add-course-list3.component.css']
})
export class AddCourseList3Component implements OnInit {
...
sendData(form:any)
{
  ...
  if(form.valid){
    this._AuthonticationService.addCourseListLev3(form.value).subscribe({
      next:(data)=>{
        // console.log({data})
