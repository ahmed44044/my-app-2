...
@Component({
  selector: 'app-stu-level3',
  templateUrl: './stu-level3.component.html',
  styleUrls: ['./stu-level3.component.css']
})
export class StuLevel3Component implements OnInit {
  ...
  ngOnInit(): void {
    this.data= this._auth.StuLevel3().subscribe({
      next:(data)=>{
